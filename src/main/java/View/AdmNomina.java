 ...
 * @author Jhon
 */
public class AdmNomina extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmNomina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
