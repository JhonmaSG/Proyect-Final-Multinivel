 ...
 * @author Jhon
 */
public class EmpAyuda extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpAyuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
