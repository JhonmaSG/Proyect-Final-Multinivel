 ...
 * @author Jhon
 */
public class AdmAyudaListView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("de al fabricacion de chaquetas para mujer");

        jLabel6.setText("Versión del Programa 1.0.1");

        jLabel7.setText("Todos los Derechos Reservados");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(51, 153, 255));
        jLabel8.setText("Contacto al Programador");
        ...
        jLabel10.setText("Enviar Ticket");

        jLabel12.setText("La empresa Jonathan's Confeccion se encarga");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmAyudaListView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdmAyudaListView().setVisible(true);
            }
        });
    }
