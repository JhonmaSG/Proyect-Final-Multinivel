 ...
 * @author Jhon
 */
public class AdmAyuda extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmAyuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
