 ...
 * @author Jhon
 */
public class EmpPrincipalListView extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public EmpPrincipalListView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpPrincipalListView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpPrincipalListView().setVisible(true);
            }
        });
    }
