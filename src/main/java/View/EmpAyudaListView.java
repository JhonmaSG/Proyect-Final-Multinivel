 ...
 * @author Jhon
 */
public class EmpAyudaListView extends javax.swing.JFrame {

    /**
     * Creates new form Principal
     */
    public EmpAyudaListView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpAyudaListView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpAyudaListView().setVisible(true);
            }
        });
    }
